...
\begin{slide}{Localisation with KNN}
    \centering
\includegraphics[width=0.6\linewidth]{images/knn_x.png}

Using the k-neareast neighbour method gives better results along the x axis (NS): up to two meters with a Kalman filter.
\end{slide}

\begin{slide}{Localisation with KNN}
    \centering
\includegraphics[width=0.6\linewidth]{images/knn_y.png}

...and slightly worse results along the y axis (WE) compared to trilateration: over five meters.
\end{slide}

\begin{slide}{Localisation with KNN}
    \centering
\includegraphics[width=0.6\linewidth]{images/knn_path.png}

Again, applying a Kalman filter gives more a smoother, more realistic path.
\end{slide}
